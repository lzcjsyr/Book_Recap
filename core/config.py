...
OPENING_REMOTION_DURATION_SECONDS = 4.0                # 开场视频时长（秒）
OPENING_REMOTION_FPS = 30                              # 开场视频帧率（fps）
OPENING_REMOTION_FIRST_LINE_SECONDS = 0.5              # 第一行金句出现时间（秒）
OPENING_REMOTION_LAST_LINE_SECONDS = 2.0               # 最后一行金句出现时间（秒）
...
TTS_SPEECH_RATE = 15                                   # 语速 (-50到100, 0=正常, 100=2倍速, -50=0.5倍速, 默认0)
...
_USER_CONFIG_ATTRS = [
    ...
    'OPENING_FADEIN_SECONDS', 'ENDING_FADE_SECONDS',
    'NARRATION_SPEED_FACTOR',
    # 视频导出参数
    'VIDEO_OUTPUT_FPS', 'VIDEO_CODEC', 'VIDEO_BITRATE_MODE', 'VIDEO_QUALITY_LEVEL',
    # 视频过渡效果
    ...
    'SUBTITLE_LINE_SPACING', 'SUBTITLE_LETTER_SPACING', 'SUBTITLE_BACKGROUND_COLOR', 'SUBTITLE_BACKGROUND_OPACITY',
    ...
    # Remotion 开场视频配置
    'OPENING_REMOTION_IP_NAME', 'OPENING_REMOTION_DURATION_SECONDS', 'OPENING_REMOTION_FPS',
    'OPENING_REMOTION_FIRST_LINE_SECONDS', 'OPENING_REMOTION_LAST_LINE_SECONDS',
    'OPENING_REMOTION_MAX_LINES', 'OPENING_REMOTION_MAX_CHARS_PER_LINE',
    # 素材处理配置
    'VIDEO_MATERIAL_REMOVE_AUDIO',
    ...
    # TTS配置
    'RESOURCE_ID', 'TTS_MODEL', 'TTS_EMOTION', 'TTS_EMOTION_SCALE',
    'TTS_SPEECH_RATE', 'TTS_LOUDNESS_RATE', 'MUTE_CUT_THRESHOLD', 'MUTE_CUT_MIN_SILENCE_MS', 'MUTE_CUT_REMAIN_MS',
    # 封面配置
    'COVER_IMAGE_MODEL', 'COVER_IMAGE_SERVER', 'COVER_IMAGE_STYLE', 'COVER_IMAGE_COUNT',
]
...
Config.BYTEDANCE_TTS_API_KEY = os.getenv('BYTEDANCE_TTS_API_KEY')
