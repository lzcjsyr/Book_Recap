...
# ════════════════════════════════════════════════════════════════════════════════
IMAGE_SERVER = "google"                            # 图像生成供应商: google_adc=本机ADC，google=GOOGLE_CLOUD_API_KEY
...
# - google_adc: 使用 gcloud application-default login 生成的本机ADC凭证，适合公司/GCP环境
# - google: 使用 .env 中 GOOGLE_CLOUD_API_KEY，适合保留旧API Key方式
