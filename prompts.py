...
IMAGE_STYLE_PRESETS = {
    ...
    "style03": "文艺复兴大师风格，历史插图质感，精细锐利的线条，仿古纸张纹理超高细节写实。高级感排版，俯视视角，米白色背景，大面积留白，物体为低饱和度的三原色。科学的诗意，深邃感。若出现人物，都是远景的黑影。字体为黑色楷体。",
    "style04": "平视视角，极致的光影效果，画面氛围是迷离虚幻的效果，超现实主义，沉浸，艺术，构图采用经典隧道构图。画面元素简单，浅色调，大片留白。",
    "style05": "概念极简摄影，单色背景，单一的突出色，巨大的留白，电影般的气氛，唤起强烈的情绪和哲学思考。",
...
COVER_IMAGE_STYLE_PRESETS = {
    ...
    "cover05": "白色渐变字体。背景为中国现代都市，深邃感，繁忙感，主色彩为秋浅金和亚麻灰。字体为楷体。",
    ...
    "cover08": "白色渐变字体。背景为破落的农村，深邃感，压抑感，主色彩为秋浅金和亚麻灰。字体为楷体。",
    "cover09": "白色渐变字体。背景为欧洲近代城市，深邃感，繁忙感，主色彩为秋浅金和亚麻灰,偏暗色调。字体为楷体。",
    "cover10": "浅色调、抽象艺术、印象派、色彩晕染、柔和过渡、光线弥漫、朦胧、梦幻、大面积留白、莫兰迪色系（浅灰蓝、藕粉、米黄）、珍珠白。情感、领悟、直觉、深度。",
}
