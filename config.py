...
IMAGE_STYLE_PRESET = "style03"                         # 段落图像风格预设 (详见 prompts.py)
...
# --- 音频控制 ---
BGM_DEFAULT_VOLUME = 0.12                              # 背景音乐音量 (0=静音, 1=原音, >1放大, 推荐0.03-0.20)
...
AUDIO_DUCKING_STRENGTH = 0.7                           # BGM压低强度 (0-1)
...
COVER_IMAGE_STYLE = "cover07"                          # 封面风格预设 (详见 prompts.py)
